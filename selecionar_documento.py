...
politicas_ecomart = carrega("data/politicas_ecomart.txt")
produtos_ecomart = carrega("data/produtos_ecomart.txt")
dados_ecomart = carrega("data/dados_ecomart.txt")
...
def selecionar_contexto(mensagem_usuario):
    ...
    resposta = resposta.choices[0].message.content.lower()
    return resposta
